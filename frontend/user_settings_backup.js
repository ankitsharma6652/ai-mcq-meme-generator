...
const UserSettings = ({ isOpen, onClose, token }) => {
    ...
    const handleFileUpload = async (e) => {
        ...
        try {
            ...
            // Using a different public Client ID that is commonly used for testing
            // If this fails, we might need to implement a backend proxy
            ...
            if (response.ok && data.success) {
                ...
                setMessage(`❌ Upload failed: ${data.data.error || 'Unknown error'}`);
            }
        } catch (error) {
